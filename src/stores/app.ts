...
const defaultAdviserPersonas: AdviserPersona = {
  id: 'alex-sterling',
  name: 'Alex Sterling',
  role: 'adviser',
...
const defaultAssistantPersonas: AdviserPersona = {
  id: 'emma-wilson',
  name: 'Emma Wilson',
  role: 'adviser',
  title: 'Adviser',
...
export const DEFAULT_PERSONAS: AdviserPersona[] = [
  defaultAdviserPersonas,
  defaultAssistantPersonas,
];
...
export const useAppStore = defineStore('app', () => {
  ...
  // Persona state
  const currentPersona = ref<AdviserPersona>(defaultAdviserPersonas);
